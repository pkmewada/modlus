...
$countSql = mysqli_query($con, "
    ...
    FROM employeeusers WHERE accountStatus='Active'
");
...
$birthdayResult = mysqli_query($con, "
    ...
    FROM employeeusers
    WHERE dateOfBirth IS NOT NULL AND accountStatus='Active'
...
$anniversaryResult = mysqli_query($con, "
    ...
    FROM employeeusers
    WHERE joiningDate IS NOT NULL AND accountStatus='Active'
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs tab-style-1" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#birthdays">
                                    Birthdays
                                </button>
                            </li>
                                    ...
                                    <table id="anniversariesTable" class="table table-hover text-nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            */
                                            ...
                                            $joiningDate =
                                                strtotime($row['joiningDate']);
                            
                                            $joiningMonthDay =
                                                date('m-d', $joiningDate);
                                            ...
                                            /*
                                            |--------------------------------------------------------------------------
                                            | Current Year Anniversary Date
                                            |--------------------------------------------------------------------------
                                            */
                            
                                            $currentYearAnniversary =
                                                strtotime(
                                                    $currentYear . '-' . $joiningMonthDay
                                                );
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?= htmlspecialchars($row['eventCategory']) ?>
                                ...
                                <div class="table-responsive">
                                    <table id="holidaysTable" class="table table-hover text-nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($row = mysqli_fetch_assoc($holidayResult)): ?>
