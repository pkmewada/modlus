...
$canImportLeads = hasActionPermission('/emp-leads', 'import_leads');
$loggedInEmployeeId = getLoggedInUserId();
...
mysqli_stmt_bind_param($selectStmt, 'i', $candidateId);
        ...
        <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-success btn-wave"
                    <?= $canImportLeads ? 'data-bs-toggle="modal" data-bs-target="#importLeadModal"' : ''; ?>
                    <?= $canImportLeads ? '' : 'disabled aria-disabled="true" title="You do not have permission to import leads"'; ?>>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item export-btn" data-type="csv"
                                                    href="javascript:void(0);">CSV</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item export-btn" data-type="pdf"
                                                    href="javascript:void(0);">PDF</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="leads-datatable" data-ui-table="mamix" class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    <!-- Empty tbody – rows are rendered client-side by lead.js -->
                                </tbody>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control"  id="modal-orgName" name="orgName"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fw-semibold mb-3" id="remarkLeadName">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="leadRemark" rows="4">
                            </textarea>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered align-middle mb-0">
                                ...
                                <tbody id="scheduledCallsTableBody">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fw-semibold mb-3" id="documentLeadName">
                        </div>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="leadStatusModalTitle">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <span id="selectedStatusText" class="fw-bold">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="statusRemark" class="form-control" rows="4"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="saveLeadStatusBtn">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="importLeadForm" enctype="multipart/form-data">
                <input type="hidden" id="importEmployeeId" name="employeeId" value="<?= (int)$loggedInEmployeeId; ?>">

                <div class="modal-body">
                    <div class="alert alert-info">
                        Upload CSV with columns:
                        <strong>fullName, email, phone, source</strong>
                    </div>

                    <div class="mb-3">
                        <label for="leadCsvFile" class="form-label">
                            Upload CSV File <span class="text-danger">*</span>
                        </label>
                        <input type="file" class="form-control" id="leadCsvFile" name="leadCsvFile" accept=".csv"
                            required>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="importLeadSubmitBtn">
                        <span class="spinner-border spinner-border-sm me-2 d-none" id="importLeadSpinner"></span>
                        Import Leads
                    </button>
                </div>
            </form>
...
<script>
    // Pass lead data to the shared lead.js
    var leadsData = <?php echo json_encode($leadsData); ?>;
</script>

<?php if ($selectStmt) { mysqli_stmt_close($selectStmt); } ?>
