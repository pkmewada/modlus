                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <!-- EXPENSE TYPE FILTER -->
                                <select id="expenseTypeFilter" class="form-select form-select-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= BASE_URL ?>/uploads/expenses/<?= urlencode($row['invoiceImage']); ?>"
            ...
            <form id="addExpenseForm" novalidate>
                ...
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control" id="invoiceImage" name="invoiceImage"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveExpenseBtn">
                        ...
                        <span class="spinner-border spinner-border-sm me-2 d-none" id="saveExpenseSpinner" role="status"
                            aria-hidden="true">
                        </span>
...
$(function() {
    ...
    */
    ...
    const rejectExpenseApiUrl = API_BASE + '/emp-rejectExpense.php';
