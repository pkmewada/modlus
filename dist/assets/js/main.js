(function () {
  ...
  window.ModlusUI = window.ModlusUI || {};
    ...
    window.ModlusUI.tableSelector = 'table[data-ui-table="mamix"]';
    window.ModlusUI.dataTableDefaults = {
        responsive: false,
        scrollX: true,
        autoWidth: false,
        destroy: true
    ...
    window.ModlusUI.withDataTableDefaults = function(options) {
        return Object.assign({}, window.ModlusUI.dataTableDefaults, options || {}, {
            responsive: false,
            scrollX: true,
            autoWidth: false,
            destroy: true
