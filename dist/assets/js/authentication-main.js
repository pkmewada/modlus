(function () {
    'use strict';
    const authAssetBase = window.AUTH_ASSET_BASE || "../assets/";

    function setBootstrapStylesheet(fileName) {
        document.querySelector("#style")?.setAttribute("href", authAssetBase + "libs/bootstrap/css/" + fileName);
    }
    ...
    if (localStorage.mamixrtl) {
        ...
        setBootstrapStylesheet("bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", (window.AUTH_ASSET_BASE || "../assets/") + "libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    let html = document.querySelector('html');
    html.setAttribute("dir", "rtl");
    document.querySelector("#style")?.setAttribute("href", (window.AUTH_ASSET_BASE || "../assets/") + "libs/bootstrap/css/bootstrap.rtl.min.css");
}
