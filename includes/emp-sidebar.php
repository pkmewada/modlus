...
$menuGroups = [
    ...
    [
        ...
        'items' => [
            ['route' => 'emp-leads', 'label' => 'Lead Records'],
        ],
    ],
    [
        'category' => 'HRMS',
        ...
        'icon' => 'ti ti-users',
        'items' => [
            ['route' => 'emp-event-holiday', 'label' => 'Events & Holidays'],
            ['route' => 'emp-apply-leave', 'label' => 'Apply Leave'],
            ['route' => 'emp-overtime-management', 'label' => 'Overtime Management'],
            ['route' => 'emp-deduction', 'label' => 'Deduction'],
            ['route' => 'emp-expense-management', 'label' => 'Expense Management'],
            ['route' => 'emp-point-transactions', 'label' => 'Point'],
            ['route' => 'emp-commission-bonus', 'label' => 'Commission Bonus'],
            ['route' => 'employee-attendance', 'label' => 'Attendance'],
        ],
    ],
];
...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="emp-dashboard" class="header-logo">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="emp-logout" class="side-menu__item">Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
