...
<body class="authentication-background">
    ...
    <div class="container-lg">
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-8 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                        ...
                        <form method="post" action="signup">
                            <div class="row gy-3">
                                <div class="col-12 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="signup-name" name="name" placeholder="Enter full name" required>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <label for="signup-phone" class="form-label text-default">Phone</label>
                                    <input type="tel" class="form-control" id="signup-phone" name="phone" placeholder="Enter phone number" required>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <label for="signup-firstname" class="form-label text-default">Email Address</label>
                                    <input type="email" class="form-control" id="signup-firstname" name="email" placeholder="Enter Email ID" required>
                                </div>
                                <div class="col-12 col-lg-6">
                                ...
                                <div class="col-12 col-lg-6">
                                    <label for="signup-confirm-password" class="form-label text-default">Confirm Password</label>
                                    <div class="position-relative">
                                        ...
                                        <a href="javascript:void(0);" class="show-password-button text-muted" onclick="createpassword('signup-confirm-password',this)" id="button-addon3"><i class="ri-eye-off-line align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center my-4 authentication-barrier">
                                <span class="op-4 fs-11">OR SignUp With</span>
                            </div>
