<?php $base = "/mamix/mamix_esbuild/dist/"; ?>
<!DOCTYPE html>
...
<body class="authentication-background">
                        ...
                        <form method="post" action="verifyotp">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12 mb-2">
                                    <div class="row">
                                        <div class="col-3">
                                            <input type="text" class="form-control text-center" id="one" name="otp1" maxlength="1" inputmode="numeric" pattern="[0-9]" oninput="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="clickEvent(this,'two')" required>
                                        </div>
                                        <div class="col-3">
                                            <input type="text" class="form-control text-center" id="two" name="otp2" maxlength="1" inputmode="numeric" pattern="[0-9]" oninput="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="clickEvent(this,'three')" required>
                                        </div>
                                        <div class="col-3">
                                            <input type="text" class="form-control text-center" id="three" name="otp3" maxlength="1" inputmode="numeric" pattern="[0-9]" oninput="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="clickEvent(this,'four')" required>
                                        </div>
                                        <div class="col-3">
                                            <input type="text" class="form-control text-center" id="four" name="otp4" maxlength="1" inputmode="numeric" pattern="[0-9]" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required>
                                        </div>
                                    </div>
                                    <div class="mt-3 text-center">
                                        <button type="submit" name="action" value="resend" formnovalidate class="btn btn-link text-primary p-0">
                                            Resend OTP
                                        </button>
                                    </div>
                                </div>
    ...
    <script src="<?= $base ?>assets/js/two-step-verification.js"></script>
